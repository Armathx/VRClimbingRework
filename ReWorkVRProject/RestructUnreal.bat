...
::copy one file for color
copy  "%BatchFileDir%/Saved/Config/WindowsEditor/EditorPerProjectUserSettings.ini" "%BatchFileDir%/EditorPerProjectUserSettings.ini" /v


:: Delete specific folders
echo Deleting Intermediate, DerivedDataCache, Build, .vs, and Binaries folders...
for %%d in (Intermediate DerivedDataCache Build .vs Binaries Saved Content/Developers) do (
...
::move the file copied in the right doc
MOVE "EditorPerProjectUserSettings.ini" "Saved/Config/WindowsEditor/EditorPerProjectUserSettings.ini"
